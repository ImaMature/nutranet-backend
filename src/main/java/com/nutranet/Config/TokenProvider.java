...
public class TokenProvider {
    ...
    // JWT 생성 및 검증을 위한 키
    private static final Key SECURITY_KEY = Keys.secretKeyFor(SignatureAlgorithm.HS512); //JWT만들 때 사용할 키
    ...
    public String create (String mid){
        ...
        String encodedKey = Base64.getEncoder().encodeToString(SECURITY_KEY.getEncoded());
